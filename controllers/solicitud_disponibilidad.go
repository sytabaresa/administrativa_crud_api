...
type SolicitudDisponibilidadController struct {
	beego.Controller
}

// URLMapping ...
func (c *SolicitudDisponibilidadController) URLMapping() {
...
// @Success 200 {object} models.SolicitudDisponibilidad
// @Failure 403 :id is empty
// @router /:id [get]
func (c *SolicitudDisponibilidadController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *SolicitudDisponibilidadController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *SolicitudDisponibilidadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *SolicitudDisponibilidadController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
